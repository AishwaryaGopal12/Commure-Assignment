INSERT INTO Patients (first_name, last_name, date_of_birth, gender, contact_number, address, email, medical_history, risk_score)
VALUES
	('John', 'Doe', '1985-05-15', 'M', '555-1234', '123 Elm St, Springfield, IL', 'john.doe@email.com', 'Hypertension', 1.2),
	('Jane', 'Smith', '1992-08-22', 'F', '555-5678', '456 Oak St, Springfield, IL', 'jane.smith@email.com', 'Asthma', 0.5),
	('Michael', 'Johnson', '1975-02-10', 'M', '555-8765', '789 Pine St, Springfield, IL', 'michael.johnson@email.com', 'Diabetes', 0.35),
	('Emily', 'Davis', '2000-11-30', 'F', '555-4321', '321 Birch St, Springfield, IL', 'emily.davis@email.com', 'None', 1.05),
	('Daniel', 'Brown', '1990-03-25', 'M', '555-6543', '654 Maple St, Springfield, IL', 'daniel.brown@email.com', 'Migraine', 0.2),
	('Olivia', 'Martinez', '1980-07-10', 'F', '555-9876', '987 Cedar St, Springfield, IL', 'olivia.martinez@email.com', 'Arthritis', 0.15),
	('James', 'Wilson', '1965-01-14', 'M', '555-1357', '159 Elm St, Springfield, IL', 'james.wilson@email.com', 'Heart disease', 1.5),
	('Sophia', 'Moore', '1995-04-05', 'F', '555-2468', '753 Oak St, Springfield, IL', 'sophia.moore@email.com', 'None', 0.48),
	('David', 'Taylor', '1983-09-20', 'M', '555-3579', '369 Pine St, Springfield, IL', 'david.taylor@email.com', 'High cholesterol', 0.68),
	('Isabella', 'Anderson', '2005-12-01', 'F', '555-4680', '741 Birch St, Springfield, IL', 'isabella.anderson@email.com', 'None', 0.85);
...
VALUES
	...
	(3, 4, '2024-11-30', '14:30', 'Annual Wellness Checkup', 'Scheduled'),
	(8, 3, '2024-11-25', '16:30', 'Annual Wellness Checkup', 'Scheduled'),
	(7, 6, '2024-11-29', '11:30', 'Annual Wellness Checkup', 'Scheduled');
...
INSERT INTO Cpts (code, description)
VALUES
	('93000', 'ECG'),
	('95812', 'EEG'),
	('73560', 'Radiology'),
	('99203', 'New Patient Dermatology'),
	('90460', 'Vaccination'),
	('47562', 'Laproscopy'),
	('99384', 'New Patient Gynecology'),
	('96127', 'Behavioral Screening'),
	('92002', 'New Patient Optomology'),
	('92557', 'Audilogic Function Test'),
	('99385', 'Wellness Visit');

INSERT INTO Billing (patient_id, appointment_id, total_amount, payment_status, payment_date, insurance_provider, cpt_code)
VALUES
	(1, 1, 100.00, 'Pending', NULL, 'Blue Cross', '93000'),
	(2, 2, 150.00, 'Paid', '2024-11-21', 'Aetna', '95812'),
	(3, 3, 200.00, 'Pending', NULL, 'Cigna', '73560'),
	(4, 4, 120.00, 'Paid', '2024-11-22', 'UnitedHealthcare', '99203'),
	(5, 5, 80.00, 'Pending', NULL, 'Blue Cross', '90460'),
	(6, 6, 500.00, 'Paid', '2024-11-23', 'Aetna', '47562'),
	(7, 7, 250.00, 'Pending', NULL, 'Cigna', '99384'),
	(8, 8, 100.00, 'Paid', '2024-11-24', 'UnitedHealthcare', '96127'),
	(9, 9, 150.00, 'Pending', NULL, 'Blue Cross', '92002'),
	(10, 10, 130.00, 'Paid', '2024-11-25', 'Aetna', '92557'),
	(3, 11, 100.00, 'Paid', '2024-12-01', 'Aetna', '99385'),
	(8, 12, 100.00, 'Pending', NULL, 'Aetna', '99385'),
	(7, 13, 100.00, 'Paid', '2024-12-01', 'Cigna', '99385');
